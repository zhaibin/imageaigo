...
- `src/index.js` - 图片详情页添加 AdSense
- `src/profile-page.js` - 个人资料页添加 AdSense + GA4
- `src/user-pages.js` - 登录/注册/密码页添加 AdSense + GA4
